...
pub struct RLEBlockIterator<T, B>
where
...
impl<T, B> BlockIterator<T::ArrayType> for RLEBlockIterator<T, B>
where
    T: RLETypeEncode + ?Sized,
    B: BlockIterator<T::ArrayType>,
{
...
mod tests {
    ...
    use crate::array::{
        ArrayBuilder, ArrayToVecExt, BlobArrayBuilder, I32ArrayBuilder, Utf8ArrayBuilder,
    };
    use crate::storage::secondary::block::{
        ...
        RLEPrimitiveBlockBuilder, RLETypeKind,
    };
    ...
    fn test_scan_rle_i32() {
        ...
        let mut scanner = RLEBlockIterator::<i32, PlainPrimitiveBlockIterator<i32>>::new(
    ...
    fn test_scan_rle_nullable_i32() {
        ...
        let mut scanner = RLEBlockIterator::<i32, PlainPrimitiveNullableBlockIterator<i32>>::new(
            block_iter, rle_data, rle_num,
        );
    ...
    fn test_scan_rle_char() {
        ...
        let mut scanner =
            RLEBlockIterator::<str, PlainCharBlockIterator>::new(block_iter, rle_data, rle_num);
    ...
    fn test_scan_rle_varchar() {
        ...
        let mut scanner = RLEBlockIterator::<str, PlainBlobBlockIterator<str>>::new(
            block_iter, rle_data, rle_num,
        );
    ...
    fn test_scan_rle_blob() {
        ...
        let builder = PlainBlobBlockBuilder::new(0);
        let mut rle_builder = RLEBlockBuilder::<BlobRef, PlainBlobBlockBuilder<BlobRef>>::new(
            builder,
            40,
            RLETypeKind::Bytes(None),
        );
        ...
        let (rle_num, rle_data, block_data) = decode_rle_block(Bytes::from(data));
        let block_iter = PlainBlobBlockIterator::new(block_data, rle_num);
        let mut scanner = RLEBlockIterator::<BlobRef, PlainBlobBlockIterator<BlobRef>>::new(
            block_iter, rle_data, rle_num,
        );
